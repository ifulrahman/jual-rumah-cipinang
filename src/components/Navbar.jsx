...
export default function Navbar({ scrollToSection }) {
  ...
  const [active, setActive] = useState("spesifikasi");
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ...
      { threshold: 0.6 } // 60% section terlihat baru dianggap aktif
    );
      ...
      <div className="bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/70">
        <div className="container flex items-center justify-between px-4 py-3 mx-auto lg:px-8">
          ...
          >
            <img
              src={logo}
              alt="Residensi Jaktim"
              className="object-contain h-12 w-18"
            />
            <h1 className="text-[14px] md:text-[18px] font-bold">
              Residensi Jaktim
            </h1>
          </a>
